...
const PAGE_CHECKS = [
  {
    path: "/",
    label: "前台学习页",
    markers: ["MR 书法 360° 全景交互演示", "taskPanel", "learningStepRoute", "learningPointRoute", "modelViewRoute", "realistic-demo.html", "lectureVoiceStatus", "historyRenameDialog", "historyRenameTitleInput", "artworkTagsDialog", "artworkTagsInput", "planReminderSummary", "planReminderServiceSummary", "planRepositorySummary", "planRepositoryExportButton", "planRepositoryImportButton", "planRepositoryEndpointInput", "planRepositoryTokenInput", "planRepositorySaveRemoteButton", "planRepositoryRemoteButton", "planRepositoryPushButton", "planRepositoryPullButton", "planReminderPermissionButton", "planCycleSummary", "planDependencyGraph", "planItemDialog", "planItemTitleInput", "planExportButton", "planNextCycleButton", "historyArtworkCompare", "historyArtworkGallery", "reviewDownloadShare", "reportDetailDownloadPdf", "reportComparison", "reportComparisonExport", "reportSeries", "reportSeriesMetricControls", "reportSeriesTemplates", "reportSeriesTooltip", "reportSeriesTooltipPin", "reportSeriesTooltipCopy", "reportSeriesZoomIn", "reportSeriesZoomOut", "reportSeriesZoomReset", "reportSeriesPointDetail", "script.js", "app-state.js"]
  },
  {
    path: "/main-admin.html",
    label: "主场景后台",
    markers: ["MR 书法主场景管理页", "mainAdminCanvas", "mainAdminRiskBanner", "projectImportExportImpact", "projectAuditExport", "projectAuditList", "mainPublishNote", "mainPublishDiffSummary", "mainPublishHistoryList", "mainRemotePublishStatus", "mainRemotePublishEndpoint", "mainRemotePublishToken", "mainRemotePublishSave", "mainRemotePublishCheck", "mainRemotePublishPush", "project-schema-utils.js", "project-remote-publish.js", "main-admin-scene.js"]
  },
  {
