...
const PAGE_CHECKS = [
  {
    path: "/",
    label: "前台学习页",
    markers: ["MR 书法 360° 全景交互演示", "taskPanel", "historyArtworkCompare", "historyArtworkGallery", "reviewDownloadShare", "reportComparison", "reportComparisonExport", "reportSeries", "reportSeriesMetricControls", "reportSeriesTemplates", "reportSeriesTooltip", "reportSeriesTooltipPin", "reportSeriesTooltipCopy", "reportSeriesZoomIn", "reportSeriesZoomOut", "reportSeriesZoomReset", "reportSeriesPointDetail", "script.js", "app-state.js"]
  },
  {
