...
const PAGE_CHECKS = [
  {
    path: "/",
    label: "前台学习页",
    markers: ["MR 书法 360° 全景交互演示", "taskPanel", "learningStepRoute", "learningPointRoute", "modelViewRoute", "realistic-demo.html", "lectureVoiceStatus", "historyRenameDialog", "historyRenameTitleInput", "artworkTagsDialog", "artworkTagsInput", "historyRepositorySummary", "historyRepositoryExportButton", "historyRepositoryImportButton", "historyRepositoryEndpointInput", "historyRepositoryTokenInput", "historyRepositorySaveRemoteButton", "historyRepositoryRemoteButton", "historyRepositoryPushButton", "historyRepositoryPullButton", "planReminderSummary", "planReminderServiceSummary", "planRepositorySummary", "planRepositoryExportButton", "planRepositoryImportButton", "planRepositoryEndpointInput", "planRepositoryTokenInput", "planRepositorySaveRemoteButton", "planRepositoryRemoteButton", "planRepositoryPushButton", "planRepositoryPullButton", "planRepositoryConflictPanel", "planRepositoryKeepLocalButton", "planRepositoryUseRemoteButton", "planRepositoryCopyRemoteButton", "planReminderPermissionButton", "planCycleSummary", "planDependencyGraph", "planItemDialog", "planItemTitleInput", "planExportButton", "planNextCycleButton", "historyArtworkCompare", "historyArtworkGallery", "reviewDownloadShare", "reportDetailDownloadPdf", "reportTeacherReviewStatus", "reportTeacherReviewInput", "reportTeacherReviewSave", "reportTeacherReviewClear", "reportComparison", "reportComparisonExport", "reportSeries", "reportSeriesMetricControls", "reportSeriesTemplates", "reportSeriesTooltip", "reportSeriesTooltipPin", "reportSeriesTooltipCopy", "reportSeriesZoomIn", "reportSeriesZoomOut", "reportSeriesZoomReset", "reportSeriesPointDetail", "script.js", "app-state.js"]
  },
  {
