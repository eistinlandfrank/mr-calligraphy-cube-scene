...
const PAGE_CHECKS = [
  {
    path: "/",
    label: "前台学习页",
    markers: ["MR 书法 360° 全景交互演示", "taskPanel", "learningPathServiceSummary", "learningStepRoute", "learningPointRoute", "modelViewRoute", "realistic-demo.html", "scoreServiceSummary", "lectureVoiceStatus", "lectureServiceSummary", "historyRenameDialog", "historyRenameTitleInput", "artworkTagsDialog", "artworkTagsInput", "historyRepositorySummary", "historyRepositoryExportButton", "historyRepositoryImportButton", "historyRepositoryEndpointInput", "historyRepositoryTokenInput", "historyRepositorySaveRemoteButton", "historyRepositoryRemoteButton", "historyRepositoryPushButton", "historyRepositoryPullButton", "historyRepositoryConflictPanel", "historyRepositoryConflictStatus", "historyRepositoryConflictList", "planReminderSummary", "planReminderServiceSummary", "planRepositorySummary", "planRepositoryExportButton", "planRepositoryImportButton", "planRepositoryEndpointInput", "planRepositoryTokenInput", "planRepositorySaveRemoteButton", "planRepositoryRemoteButton", "planRepositoryPushButton", "planRepositoryPullButton", "planRepositoryReceiptAudit", "planRepositoryReceiptStatus", "planRepositoryReceiptList", "planRepositoryReceiptExportButton", "planRepositoryConflictPanel", "planRepositoryKeepLocalButton", "planRepositoryUseRemoteButton", "planRepositoryCopyRemoteButton", "planRepositoryMergeFieldsButton", "planReminderPermissionButton", "planCycleSummary", "planDependencyGraph", "planItemDialog", "planItemTitleInput", "planExportButton", "planCalendarExportButton", "planNextCycleButton", "historyArtworkCompare", "historyArtworkGallery", "reviewDownloadShare", "shareServiceSummary", "reviewCreateShareLink", "reviewCopyShareLink", "reviewRevokeShareLink", "shareServiceRecords", "reportVerification", "reportRepositorySummary", "reportRepositoryExportButton", "reportRepositoryImportButton", "reportRepositoryImportInput", "reportRepositoryEndpointInput", "reportRepositoryTokenInput", "reportRepositorySaveRemoteButton", "reportRepositoryRemoteButton", "reportRepositoryPushButton", "reportRepositoryPullButton", "reportRepositoryReceiptAudit", "reportRepositoryReceiptStatus", "reportRepositoryReceiptList", "reportRepositoryReceiptExportButton", "reportRepositoryConflictPanel", "reportRepositoryConflictStatus", "reportRepositoryConflictList", "reportDetailDownloadPdf", "reportTeacherReviewStatus", "reportTeacherReviewInput", "reportTeacherReviewSave", "reportTeacherReviewClear", "reportComparison", "reportComparisonExport", "reportSeries", "reportSeriesMetricControls", "reportSeriesTemplates", "reportSeriesTooltip", "reportSeriesTooltipPin", "reportSeriesTooltipCopy", "reportSeriesZoomIn", "reportSeriesZoomOut", "reportSeriesZoomReset", "reportSeriesPointDetail", "script.js", "app-state.js"]
  },
  {
    path: "/main-admin.html",
    label: "主场景后台",
    markers: ["MR 书法主场景管理页", "mainAdminCanvas", "mainAdminRiskBanner", "projectRepositoryStatus", "projectRepositoryList", "projectRepositoryRefresh", "projectRepositoryRemoteStatus", "projectRepositoryEndpoint", "projectRepositoryToken", "projectRepositorySaveRemote", "projectRepositoryCheckRemote", "projectRepositoryPushRemote", "projectRepositoryPullRemote", "projectRepositoryVersionSelect", "projectRepositoryReceiptAudit", "projectRepositoryReceiptStatus", "projectRepositoryReceiptList", "projectRepositoryReceiptExport", "projectImportExportImpact", "projectAuditExport", "projectAuditList", "mainPublishNote", "mainPublishDiffSummary", "mainPublishHistoryList", "mainRemotePublishStatus", "mainRemotePublishEndpoint", "mainRemotePublishToken", "mainRemotePublishSave", "mainRemotePublishCheck", "mainRemotePublishPush", "mainRemotePublishReviewStatus", "mainRemotePublishRequestReview", "mainRemotePublishApproveReview", "mainRemotePublishRejectReview", "mainRemotePublishUnlock", "mainRemotePublishReceiptStatus", "mainRemotePublishReceiptList", "mainRemotePublishReceiptExport", "project-schema-utils.js", "project-remote-publish.js", "main-admin-scene.js"]
  },
  {
