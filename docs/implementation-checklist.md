...
- [ ] **P5-01：建立 CaregiverDashboard 组件**  
...
- [ ] **P6-03：建立 SceneEditor 布局**  
  验收：页面包含对象树、3D 视窗、属性面板。

- [ ] **P6-04：建立 3D Viewport**  
  验收：后台能渲染当前选中场景。
...
- [ ] **P6-16：导出 SceneConfig JSON**  
  验收：可下载当前场景 JSON。

- [ ] **P6-17：导入 SceneConfig JSON**  
  验收：导入后场景恢复，并通过配置校验。
