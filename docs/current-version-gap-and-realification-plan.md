...
| 学习计划 | 可按本机状态生成、勾选、顺延、复盘、管理计划项，显示任务依赖图，生成下周期，并可导出离线 HTML 计划单 | 缺远端提醒和跨设备同步 | 增加本机提醒 fallback 与远端计划 repository |
...
3. 学习计划已有到期、提醒、顺延、复盘、依赖图、周期循环和离线导出，但还缺跨设备提醒。
...
| 优先级 | 功能 | 原因 | 交付物 |
| --- | --- | --- | --- |
| P0 | 学习计划提醒服务边界 | 计划已有提醒、复盘、依赖图、周期循环和导出，但还没有浏览器提醒 fallback 或远端提醒 | 本机提醒说明、通知权限边界、远端计划 repository 草案 |
